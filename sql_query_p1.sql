...
-- Q 8 Write a SQL Query to find tthe top 5 customers based on the highest total sales.
...
-- Q 10 Write a SQL Query to create each shift and number of order (Example Morning <= 12, Afternoon 12 & 17, Evening > 17)
WITH hourly_sale
AS
(
SELECT *,
